...
# sum counts (counts are undertaken in 5 time intervals)
BBA_Wren <- bba %>%
...
# data stacks----
stk.BBS <- MakePointsStack(presences = BBS_sp, data = covariates, mesh = Mesh$mesh, 
...
warbler_model <- FitModel(stk.BBS, stk.gbif, stk.BBA,
